           ...
           <div className=" order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32" >
             <div className='space-y-12'>
               <h1 className="text-4xl font-bold">Hello, welcome here to learn something <span className="text-pink-500">new everyday!!!</span></h1>
                ...
                Fugit reprehenderit debitis quibusdam optio recusandae nobis nostrum quis nulla 
                corrupti distinctio velit placeat reiciendis illo non, quia adipisci ut mollitia exercitationem!
                </p>
